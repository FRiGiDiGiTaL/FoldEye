        ...
        <div className="flex-1">
          <h2 className="text-lg font-bold text-yellow-300 flex items-center justify-between">
            <span className="flex items-center">
              {title}
              {isPremium && (
                <span className="ml-2 text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-0.5 rounded-full animate-pulse">
                  PRO
                </span>
              )}
            </span>
  ...
  return (
    <aside className="w-full glass-panel-dark p-4 flex-shrink-0 shadow-2xl md:w-96 md:h-screen md:overflow-y-auto border-r border-gray-600/30 overflow-y-auto max-h-screen">
      ...
      <div className="space-y-3">
        ...
        {/* Enhanced Camera & AR Overlay - Partially Premium */}
        <CollapsibleSection
          stepNumber={2}
        ...
        {/* Enhanced Page & Mark Navigation - Always Available */}
        <CollapsibleSection
          stepNumber={4}
        ...
        {/* Enhanced Marking Instructions - Always Available */}
        <CollapsibleSection
          stepNumber={6}
